package com.exmaple.school.service;

import com.exmample.school.model.Student;
...
public class StudentH2Service implements StudentRepository {
    ...
    public ArrayList<Student> getStudents() {
        List<Student> studentDataList = db.query("select * from student", new StudentRowMapper());
    ...
    public String addMultipleStudents(ArrayList<Student> studentsList) {
        ...
        String respondeMessage = String.format("Successfully added %d students", studentlist.size());
